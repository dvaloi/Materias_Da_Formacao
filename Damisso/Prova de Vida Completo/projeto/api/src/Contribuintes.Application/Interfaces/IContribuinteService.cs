...
public interface IContribuinteService
{
    ...
    Task<IReadOnlyList<PensionistaResumoDto>> ListarPensionistasAsync(CancellationToken ct = default);
    Task<PensionistaResumoDto?> ObterPensionistaPorNuitAsync(string nuit, CancellationToken ct = default);
}
